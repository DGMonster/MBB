...
If World of Warcraft receives a new patch and the interface version changes, the addon can warn the user that an update may be required.
...
## Localization
MBB Reborn supports multiple languages.

English (enUS) is the default fallback language.  
Additional translations are community-driven.

If you want to help translating the addon into your language, feel free to contribute via GitHub.
